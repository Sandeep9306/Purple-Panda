  ...
  return (
    <>
      <section className="py-5 my-lg-5">
        <Container>
          <Row className="ff_montserrat fw_semibold justify-content-lg-between justify-content-around">
            <Col lg={5}>
              <img src={Samples} alt="Samples" className="w-100" />
            </Col>
            <Col sm={6} lg={3}>
              <div className="d-flex align-items-center my-4">
                <img src={Devilery} alt="Devilery" />
