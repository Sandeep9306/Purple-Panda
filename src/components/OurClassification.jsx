          ...
          <Row>
            <Col lg={6} className="">
              <div className="p-3 p-md-5 bg_blure  border_effect position-relative border_purple">
                ...
                <button className="border-0 bg_linear text-white ff_montserrat fw-bold rounded-5 px-5 py-3 bg_hover fs_md mt-3">
                  TRY PURPLE PANDA TODAY
                </button>
              </div>
            </Col>
            <Col lg={6} className="my-4">
              {/* <img src={pt} alt="Classifications" /> */}
              {/* <img src={Classifications} alt="Classifications" /> */}
            </Col>
          </Row>
        </Container>
      </section>
