  ...
  return (
    <>
      <section className="my-5 py-5 d-flex align-items-center ">
        <Container className="my-5 position-relative bg_blure ">
          <Row className="align-items-center text-center text-lg-start pt-5  pb-0  pb-lg-5 column-reverse justify-content-lg-around ">
            ...
            <Col lg={5} className="z_index_n1">
              <img
                src={Mushroom}
                alt="Mushroom"
                className="position-absolute  translate_middle d-none d-lg-flex "
              />
              <img
                src={Mushroom}
                alt="Mushroom"
